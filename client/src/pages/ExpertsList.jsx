    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500">Verified experts across AI, engineering, regulatory compliance, sustainability and more.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-6">
          ...
          <aside className="lg:col-span-1">
            <div className="card p-5 sticky top-24 space-y-5">
              ...
              <button
                onClick={() => setFilters({ search: '', min_price: '', max_price: '', location: '', expertise: '' })}
          ...
          <div className="lg:col-span-3">
            ...
            {loading ? (
              ...
              <div className="card p-12 text-center">
                ...
                <p className="text-gray-500 mb-2">No experts found matching your criteria.</p>
                <button onClick={() => setFilters({ search: '', min_price: '', max_price: '', location: '', expertise: '' })} className="btn-secondary text-sm">
                  Clear filters
                </button>
              </div>
            ) : (
